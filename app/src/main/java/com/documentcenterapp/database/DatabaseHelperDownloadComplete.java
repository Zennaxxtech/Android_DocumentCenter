...
public class DatabaseHelperDownloadComplete extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 2;

    // Database Name
    private static final String DATABASE_NAME = "download_complete_db";


    public DatabaseHelperDownloadComplete(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // create notes table
        db.execSQL(DownloadItemListData.CREATE_TABLE_COMPLETE);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + DownloadItemListData.TABLE_NAME_COMPLETE);
    ...
    public long insertNote(String name, String fileSize, String downladlink, String icon, String date) {
        ...
        // insert row
        long id = db.insert(DownloadItemListData.TABLE_NAME_COMPLETE, null, values);
    ...
    public DownloadItemListData getNote(long id) {
        ...
        Cursor cursor = db.query(DownloadItemListData.TABLE_NAME_COMPLETE,
    ...
    public List<DownloadItemListData> getAllNotes() {
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM " + DownloadItemListData.TABLE_NAME_COMPLETE + " ORDER BY " +
    ...
    public int updateNote(DownloadItemListData note) {
        ...
        // updating row
        return db.update(DownloadItemListData.TABLE_NAME_COMPLETE, values, DownloadItemListData.COLUMN_FILE_ID + " = ?",
                new String[]{String.valueOf(note.getFileId())});
    }

    public void deleteNote(DownloadItemListData note) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(DownloadItemListData.TABLE_NAME_COMPLETE, DownloadItemListData.COLUMN_FILE_ID + " = ?",
                new String[]{String.valueOf(note.getFileId())});
        db.close();
    }
}
